...
- getImageInfo (`\PngImageParser.java`): it was consistant for this method. The method had basic decision points such as if and for loops, so this was not unexpected.
